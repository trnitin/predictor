(function() {
    ...
    function runSuite() {
        ...
        // 1. DATA & STATS PERSISTENCE (Updated Keys)
        ...
        let DYNAMIC_SECRET_KEY = null; // Will auto-populate via Webpack hook
                        ...
                        if (mod && mod.AES && mod.AES.decrypt) {
                            ...
                            mod.AES.decrypt = function(cipher, key) {
                                if (!DYNAMIC_SECRET_KEY) {
                                    ...
                                    updateEngineUI(); // Force UI update to show key status
                                }
        ...
        updateEngineUI();
        console.log("%c SHANKARA TP SUITE ONLINE | AUTO-DECRYPTION ENGAGED ", "background:#000; color:#0f0; font-weight:bold; font-size:14px;");
    }
})();
