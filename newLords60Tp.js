    ...
    // 3. LOGIC ENGINE (v2.5 Smart Recency)
    function getDynamicPrediction(data) {
        ...
        // LAYER 1: ELITE DEEP PATTERNS (Highest Priority)
        for (let d of [5, 4]) {
        ...
        // LAYER 2: MACRO TREND OVERRIDE (Protects against weak patterns in biased shoes)
    ...
    function updateEngineUI() {
        ...
        intelEl.innerHTML = `
            <div style="display:flex;justify-content:space-between;border-bottom:1px solid #333;padding-bottom:5px;margin-bottom:8px;">
                <b style="color:#0ff;">1-DAY TP MASTER (V2.5 SMART)</b>
    ...
    updateEngineUI();
    console.log("%c MASTER 1-DAY TP SUITE ONLINE | V2.5 SMART RECENCY ACTIVE ", "background:#000; color:#0f0; font-weight:bold; font-size:14px;");
})();