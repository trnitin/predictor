(function() {
    ...
    function runSuite() {
        ...
        // 4. OMNI-SNIPER LOGIC ENGINE (V6.0 Hybrid)
        ...
        function detectRegime(validHistory) {
            ...
            let alphaW = 0, alphaL = 0; // Follow Sniper
            let betaW = 0, betaL = 0;   // Fade Sniper
        ...
        function updateEngineUI() {
            ...
            intelEl.innerHTML = `
                ...
                <div style="display:flex;justify-content:space-between;border-bottom:1px solid #333;padding-bottom:5px;margin-bottom:8px;">
                    <b style="color:#0ff;">SHANKARA TP (V6.0 OMNI-SNIPER)</b>
        ...
        // 7. AUTO-CLICKER & WAGER EXECUTION (SHANKARA TARGETS)
        ...
        function processHistoryArray(historyArray) {
            ...
            recentRounds.forEach(d => {
                ...
                if (!alreadyLogged) {
                    ...
                    // Only log PNL stats if the bot has exited Warmup and actually placed a bet
        ...
        updateEngineUI();
        console.log("%c SHANKARA TP SUITE ONLINE | V6.0 OMNI-SNIPER AUTO-BET ENGAGED ", "background:#000; color:#0f0; font-weight:bold; font-size:14px;");
    }
})();
    ...
    function runSuite() {
        ...
        function updateEngineUI() {
            ...
            intelEl.innerHTML = `
                <style>@keyframes blink { 50% { opacity: 0; } }</style>
                <div style="display:flex;justify-content:space-between;border-bottom:1px solid #333;padding-bottom:5px;margin-bottom:8px;">
                    <b style="color:#0ff;">SHANKARA TP (OMNI-SNIPER ADVISORY)</b>
                    <span style="font-size:10px;color:#888;">${storage.percent}% DB</span>
                </div>
                <div style="text-align:center;font-size:10px;margin-bottom:5px;">
                    ${keyStatus}
        ...
        function processHistoryArray(historyArray) {
            ...
            recentRounds.forEach(d => {
                ...
                if (!alreadyLogged) {
                    ...
                    // Only log PNL stats if the bot has exited Warmup and actually placed a virtual bet
                    if (window.tpLogs.length >= 25) {
                        const simPred = getDynamicPrediction(window.tpLogs);
                        if (simPred && simPred.win !== "WAIT") {
                            if (winner === "TIE") {
        ...
        updateEngineUI();
        console.log("%c SHANKARA TP SUITE ONLINE | OMNI-SNIPER ADVISORY (NO AUTO-BET) ENGAGED ", "background:#000; color:#0f0; font-weight:bold; font-size:14px;");
    }
})();