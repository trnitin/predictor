(function() {
    ...
    function runSuite() {
        ...
        // 7. AUTO-CLICKER & WAGER EXECUTION (Shankara HTML Structure)
                ...
                if (stakeInput && submitBtn) {
                    ...
                    setTimeout(() => {
                        if (!submitBtn.disabled) {
                            submitBtn.click();
                            console.log(`%c [AUTO-BET] SUCCESS! 250 Stake submitted.`, "color:#0f0;font-weight:bold;");
                        } else {
        ...
        updateEngineUI();
        console.log("%c SHANKARA TP SUITE ONLINE | V2.5 LOGIC & AUTO-CLICKER ENGAGED ", "background:#000; color:#0f0; font-weight:bold; font-size:14px;");
    }
})();